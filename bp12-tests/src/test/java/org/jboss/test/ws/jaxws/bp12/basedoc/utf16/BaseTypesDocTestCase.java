...
public class BaseTypesDocTestCase extends BPTest
{
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp12basedoc-utf16.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            ...
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp12/basedoc-utf16/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp12/basedoc-utf16/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
