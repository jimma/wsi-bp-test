...
public class Test1189AnonTestCase extends BPTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   public static WebArchive createDeployment()
   {
      ...
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp12/wsa/test1189-anon/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
   ...
   public void testWSA() throws Exception
   {
      ...
      ((BindingProvider) port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY,
            getProxyAddress(baseURL) + "/Test1189Anon");
