 ...
 */
package org.jboss.test.ws.jaxws.bp12.wsa.test119x;
...
public class Test119XTestCase extends BP12Test
{
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp12test119x.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            .addPackages(false, Filters.exclude(Test119XTestCase.class), Test119XTestCase.class.getPackage().getName())
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp12/wsa/test119x/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp12/wsa/test119x/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
   @Test
   @RunAsClient 
   public void testWSA() throws Exception
   {
      ...
      System.out.println(getProxyAddress(baseURL) + "Test119x");
