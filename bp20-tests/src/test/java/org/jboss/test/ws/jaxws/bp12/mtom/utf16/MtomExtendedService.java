...
public class MtomExtendedService extends Service {
    ...
    static {
        URL url = MtomExtendedService.class.getResource("Soap12MtomUtf16.wsdl");
        if (url == null) {
            url = MtomExtendedService.class.getClassLoader().getResource("Soap12MtomUtf16.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(MtomExtendedService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "Soap12MtomUtf16.wsdl");
        }       
        WSDL_LOCATION = url;
    }
