...
@XmlType(name = "SignatureHeaderFaultContract", propOrder = {
    "faultAdditionalText"
})
public class SignatureHeaderFaultContract {

    @XmlElementRef(name = "FaultAdditionalText", namespace = "http://example.org/signature", type = JAXBElement.class, required = false)
