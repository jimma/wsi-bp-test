 ...
 */
package org.jboss.test.ws.jaxws.bp20.wsa.test1189.nonanon;
...
public class Test1189NonAnonTestCase extends BP20Test
{
   @ArquillianResource
   private URL baseURL;
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp20test1189-nonanon.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            ...
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/wsa/test1189-nonanon/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/wsa/test1189-nonanon/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
   ...
   public void testWSA() throws Exception
   {
      ...
      // invoke method
      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, getProxyAddress(baseURL) + "/Test1189NonAnon");
