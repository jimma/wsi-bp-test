 ...
 */
package org.jboss.test.ws.jaxws.bp20.wsa.test1192;
...
public class Test1192TestCase extends BP20Test
{
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp20test1192.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            .addPackages(false, Filters.exclude(Test1192TestCase.class), Test1192TestCase.class.getPackage().getName())
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/wsa/test1192/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/wsa/test1192/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
