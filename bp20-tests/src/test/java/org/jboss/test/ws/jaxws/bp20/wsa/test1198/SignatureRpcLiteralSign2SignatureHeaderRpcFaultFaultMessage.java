...
public class SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage extends Exception {
    ...
    private org.jboss.test.ws.jaxws.bp20.wsa.test1198.SignatureHeaderFaultContractRpc signatureHeaderFaultContractRpc;
    ...
    public SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp20.wsa.test1198.SignatureHeaderFaultContractRpc signatureHeaderFaultContractRpc) {
        super(message);
        this.signatureHeaderFaultContractRpc = signatureHeaderFaultContractRpc;
    }

    public SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp20.wsa.test1198.SignatureHeaderFaultContractRpc signatureHeaderFaultContractRpc, Throwable cause) {
        super(message, cause);
        this.signatureHeaderFaultContractRpc = signatureHeaderFaultContractRpc;
    }

    public org.jboss.test.ws.jaxws.bp20.wsa.test1198.SignatureHeaderFaultContractRpc getFaultInfo() {
