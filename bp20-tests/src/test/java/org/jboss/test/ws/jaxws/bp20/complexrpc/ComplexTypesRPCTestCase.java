...
public class ComplexTypesRPCTestCase extends BP20Test
{
   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-bp20complexrpc/ComplexRPC";

   public static Test suite()
   {
      return new JBossWSCXFTestSetup(ComplexTypesRPCTestCase.class, "jaxws-bp20complexrpc.war");
   }
   ...
   public void testAllTypes() throws Exception
   {
      ...
      ((BindingProvider) port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY,
            PROXY_ADDRESS + "/jaxws-bp20complexrpc/ComplexRPC");
