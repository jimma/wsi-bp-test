...
public class SignatureDocumentLiteralSign7SignatureHeaderFaultFaultMessage extends Exception {
    ...
    public SignatureDocumentLiteralSign7SignatureHeaderFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp20.wsa.test1197.SignatureHeaderFaultContract signatureHeaderFaultContract) {
        super(message);
        this.signatureHeaderFaultContract = signatureHeaderFaultContract;
    }

    public SignatureDocumentLiteralSign7SignatureHeaderFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp20.wsa.test1197.SignatureHeaderFaultContract signatureHeaderFaultContract, Throwable cause) {
        super(message, cause);
        this.signatureHeaderFaultContract = signatureHeaderFaultContract;
    }

    public org.jboss.test.ws.jaxws.bp20.wsa.test1197.SignatureHeaderFaultContract getFaultInfo() {
