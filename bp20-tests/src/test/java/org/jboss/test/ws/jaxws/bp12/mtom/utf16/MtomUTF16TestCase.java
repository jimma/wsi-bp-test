...
public class MtomUTF16TestCase extends JBossWSTest
{
	   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-bp12mtom-utf16/Mtom";

	   public static Test suite()
	   {
	      return new JBossWSCXFTestSetup(MtomUTF16TestCase.class, "jaxws-bp12mtom-utf16.war");
	   }
	   ...
	   public void testAll() throws Exception
	   {
	      ...
	      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "http://localhost:9090/jaxws-bp12mtom-utf16/Mtom");
