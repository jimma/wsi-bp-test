...
{
	   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-bp20mtom/Mtom";

	   public static Test suite()
	   {
	      return new JBossWSCXFTestSetup(MtomTestCase.class, "jaxws-bp20mtom.war");
	   }
	   ...
	   public void testAll() throws Exception
	   {
	      ...
	      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, PROXY_ADDRESS + "/jaxws-bp20mtom/Mtom");
