...
public class BaseTypesDocTestCase extends BP20Test
{
   ...
   {
      return new JBossWSCXFTestSetup(BaseTypesDocTestCase.class, "jaxws-bp20basedoc-utf16.war");
   }
   ...
   public void testAllTypes() throws Exception
   {
      ...
      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, PROXY_ADDRESS + "/jaxws-bp20basedoc-utf16/BPBaseDoc");
