...
public class BaseTypesDocTestCase extends BPTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp20basedoc-utf16.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            ...
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/basedoc-utf16/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/basedoc-utf16/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
