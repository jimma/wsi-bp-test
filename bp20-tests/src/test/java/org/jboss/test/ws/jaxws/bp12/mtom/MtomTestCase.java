...
{
	   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-bp12mtom/Mtom";

	   public static Test suite()
	   {
	      return new JBossWSCXFTestSetup(MtomTestCase.class, "jaxws-bp12mtom.war");
	   }
	   ...
	   public void testAll() throws Exception
	   {
	      ...
	      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "http://localhost:9090/jaxws-bp12mtom/Mtom");
