...
public class SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage extends Exception {
    ...
    public SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp12.wsa.test1198.SignatureHeaderFaultContractRpc signatureHeaderFaultContractRpc) {
        super(message);
        this.signatureHeaderFaultContractRpc = signatureHeaderFaultContractRpc;
    }

    public SignatureRpcLiteralSign2SignatureHeaderRpcFaultFaultMessage(String message, org.jboss.test.ws.jaxws.bp12.wsa.test1198.SignatureHeaderFaultContractRpc signatureHeaderFaultContractRpc, Throwable cause) {
        super(message, cause);
        this.signatureHeaderFaultContractRpc = signatureHeaderFaultContractRpc;
    }
