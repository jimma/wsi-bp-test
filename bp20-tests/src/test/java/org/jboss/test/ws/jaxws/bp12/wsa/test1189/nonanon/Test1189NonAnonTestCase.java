...
public class Test1189NonAnonTestCase extends JBossWSTest
{
   ...
   {
      return new JBossWSCXFTestSetup(Test1189NonAnonTestCase.class, "jaxws-bp12test1189-nonanon.war");
   }
   ...
   public void testWSA() throws Exception
   {
      ...
      ((BindingProvider) port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY,
            "http://localhost:9090/jaxws-bp12test1189-nonanon/Test1189NonAnon");
