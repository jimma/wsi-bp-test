...
{
	   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-bp20mtom-utf16/Mtom";

	   public static Test suite()
	   {
	      return new JBossWSCXFTestSetup(MtomUTF16TestCase.class, "jaxws-bp20mtom-utf16.war");
	   }
	   ...
	   public void testAll() throws Exception
	   {
	      ...
	      ((BindingProvider)port).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, PROXY_ADDRESS + "/jaxws-bp20mtom-utf16/Mtom");
