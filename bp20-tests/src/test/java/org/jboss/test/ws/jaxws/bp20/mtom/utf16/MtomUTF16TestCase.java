...
public class MtomUTF16TestCase extends BP20Test
{
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxws-bp20mtom-utf16.war");
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n" + "Dependencies: org.apache.cxf\n"))
            .addPackages(false, Filters.exclude(MtomUTF16TestCase.class), MtomUTF16TestCase.class.getPackage().getName())
            .setWebXML(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/mtom-utf16/WEB-INF/web.xml"));
      addResroucesToWebInf(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/bp20/mtom-utf16/WEB-INF", archive, "wsdl", "xsd");
      return archive;
   }
