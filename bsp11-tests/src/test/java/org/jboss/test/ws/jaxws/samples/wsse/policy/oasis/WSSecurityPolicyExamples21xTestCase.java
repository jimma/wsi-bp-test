...
public final class WSSecurityPolicyExamples21xTestCase extends BSP11Test
{
   ...
   public void test2111() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService2111");
   ...
   public void test2112() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService2112");
   ...
   public void test2113() throws Exception
   {
      ...
      setupWsse(proxy, true);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService2113");
   ...
   public void test213() throws Exception
   {
      ...
      setupWsse(proxy, true);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService213");
   ...
   public void test214() throws Exception
   {
      ...
      setupWsse(proxy, false);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService214");
