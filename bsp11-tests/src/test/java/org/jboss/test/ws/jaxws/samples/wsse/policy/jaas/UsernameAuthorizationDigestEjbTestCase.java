...
public final class UsernameAuthorizationDigestEjbTestCase extends BSP11Test
{
   @ArquillianResource
   private URL baseURL;
   ...
   public void test() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/jaxws-samples-wsse-policy-username-jaas-ejb-digest/SecurityService/EJBDigestServiceImpl");
