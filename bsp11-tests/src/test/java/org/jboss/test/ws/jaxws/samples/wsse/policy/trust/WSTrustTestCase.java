...
public class WSTrustTestCase extends BPTest
{
   ...
   public void test() throws Exception
   {
      ...
      try
      {
         ...
         ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(serviceURL) + "/SecurityService");
   ...
   public void testActAs() throws Exception
   {
      ...
      try
      {
         ...
         ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(serviceURL) + "/ActAsService");
   ...
   public void testOnBehalfOf() throws Exception
   {
      ...
      try
      {
         ...
         ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(serviceURL) + "/OnBehalfOfService");
   ...
   public void testBearer() throws Exception
   {
      ...
      try
      {
         ...
         ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(serviceURL) + "/BearerService");
