...
public final class UsernameAuthorizationDigestTestCase extends BSP11Test
{
   @ArquillianResource
   private URL baseURL;
   ...
   public void test() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL));
