...
public final class WSSecurityPolicyExamples22xTestCase extends BSP11Test
{
   ...
   public void test221() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService221");
   ...
   public void test222() throws Exception
   {
      ...
      setupWsse(proxy, true);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService222");
      try {
   ...
   public void test223() throws Exception
   {
      ...
      setupWsse(proxy, true);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService223");
   ...
   public void test224() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService224");
