...
/**
 * WS-Security Policy sign & encrypt test case using GCM algorithm suite
 *
...
public final class SignEncryptGCMTestCase extends JBossWSTest
{
   ...
   {
      URL url = new URL(baseURL + "?path=/jaxws-samples-wsse-policy-sign-encrypt-gcm&method=testSignEncryptUsingConfigProperties&helper="
