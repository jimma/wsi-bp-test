...
public final class UsernameTestCase extends BSP11Test
{
   @ArquillianResource
   private URL baseURL;
   ...
   public void test() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/service");
   ...
   public void testJavaFirst() throws Exception
   {
      ...
      setupWsse((BindingProvider)proxy, "kermit");
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/javafirst-service");
      assertEquals("Secure Hello World!", proxy.sayHello());
   }
