...
public final class SecureConversationTestCase extends BSP11Test
{
   ...
   public void test() throws Exception
   {
      ...
      URL wsdlURL = new URL(baseURL + "/SecureConversationService?wsdl");
      Service service = Service.create(wsdlURL, serviceName);
      ServiceIface proxy = (ServiceIface)service.getPort(ServiceIface.class);
      setupWsse(proxy, true);
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecureConversationService");
