...
public final class MultipleClientsSignEncryptTestCase extends BSP11Test
{
   ...
   public void testAlice() throws Exception
   {
      ...
      ((BindingProvider)proxy).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, this.getBSPProxyBaseURL(baseURL) + "/SecurityService");
      try
      {
